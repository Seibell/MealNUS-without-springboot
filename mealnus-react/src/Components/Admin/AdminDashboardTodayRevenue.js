...
export default function AdminDashboardTodayRevenue() {
    const [data, setData] = useState(0);

    const targetRevenue = 35000;
    ...
    return (
        <React.Fragment>
            <div className="grid-container grid-item-revenue">
                <LocalAtmTwoToneIcon />
                <AdminTitle>Today's Revenue</AdminTitle>
