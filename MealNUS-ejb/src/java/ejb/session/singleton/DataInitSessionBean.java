    ...
    public void postConstruct() {
        ...
        if (promotionSessionBean.retrieveAllPromotions().isEmpty()) {
            try {
                ...
                promotionSessionBean.createPromotion(new Promotion("Promotion 1", "https://cdn.hellofresh.com/us/lp/images/hellofresh-coupons-and-promos-30OFF.jpg", startDate, endDate, BigDecimal.valueOf(0.5)));
                
                Promotion promoApplied = new Promotion("Promotion Applied", "https://cdn.hellofresh.com/us/lp/images/hellofresh-coupons-and-promos-30OFF.jpg", startDate, endDate,  BigDecimal.valueOf(0.7));
